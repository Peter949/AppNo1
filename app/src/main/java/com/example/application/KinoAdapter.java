...
public class KinoAdapter extends RecyclerView.Adapter<KinoAdapter.ViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(mContext, KinoActivity.class);
                intent.putExtra("id", kinoParam.getMovieId());
                intent.putExtra("name", kinoParam.getName());
                intent.putExtra("description", kinoParam.getDescription());
                intent.putExtra("image", kinoParam.getPoster());
