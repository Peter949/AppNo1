...
public class Application extends AppCompatActivity
{
    ...
    private ConstraintLayout arrayOfKino, someLayout;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        arrayOfKino = findViewById(R.id.arrayOfKino);
        someLayout = findViewById(R.id.someLayout);
        mainText = findViewById(R.id.nameApplication);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                switch (item.getItemId())
                {
                    case R.id.action_map:
                        arrayOfKino.setVisibility(View.VISIBLE);
                        someLayout.setVisibility(View.GONE);
                        mainText.setText("Кино поиск");
                        break;
                    case R.id.action_dial:
                        arrayOfKino.setVisibility(View.GONE);
